...
public class UTF8FileReaderTest {
	...
	public static final File testFileDir = new File("testFiles");
	private static int fileInd = 1;
		
	@Test
	public void checkFilePos() throws IOException, IllegalFormatException{
		try(UTF8FileReader reader = new UTF8FileReader(new File(testFileDir, "UTF8FileReaderPositionTest.txt"))){
	...
	public void shouldFindClosingQuotes() throws IOException, IllegalFormatException{
		File file = getGeneratedFileName();
